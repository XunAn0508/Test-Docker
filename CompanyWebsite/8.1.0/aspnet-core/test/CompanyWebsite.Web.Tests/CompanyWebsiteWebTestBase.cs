...
{
    public abstract class CompanyWebsiteWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CompanyWebsiteWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CompanyWebsiteWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CompanyWebsiteDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CompanyWebsiteDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CompanyWebsiteDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CompanyWebsiteDbContext, Task<T>> func)
        {
            T result;
