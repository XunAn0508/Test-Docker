...
using Abp.UI;
using CompanyWebsite.Authentication.External;
using CompanyWebsite.Authentication.JwtBearer;
...
namespace CompanyWebsite.Controllers
{
    ...
    public class TokenAuthController : CompanyWebsiteControllerBase
    {
