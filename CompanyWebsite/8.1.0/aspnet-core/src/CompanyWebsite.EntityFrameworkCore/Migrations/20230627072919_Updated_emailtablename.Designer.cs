...
namespace CompanyWebsite.Migrations
{
    ...
    [Migration("20230627072919_Updated_emailtablename")]
    partial class Updated_emailtablename
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompanyWebsite.Applicants.Applicant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CompanyWebsite.Careers.Career", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CompanyWebsite.Documents.Document", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CompanyWebsite.SendEmail.EmailQueues", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("CompanyWebsite.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("CompanyWebsite.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("CompanyWebsite.Applicants.Applicant", b =>
                {
                    b.HasOne("CompanyWebsite.Careers.Career", "Career")
                        .WithMany()
