...
namespace CompanyWebsite.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = CompanyWebsiteConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(CompanyWebsiteDbContext context)
        {
            _context = context;
        }
